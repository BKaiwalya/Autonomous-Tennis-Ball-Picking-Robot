...
def main():
    ...
    while(1):
        ...
        if(frontFound == 1 and backFound == 1):
            ...
            cv2.rectangle(img,
                          (frontX, frontY),                 # upper left corner
                          (frontX+frontWidth,frontY+frontHeight),        # lower right corner
                          (0, 0, 255),                  # red
                          3)
            cv2.rectangle(img,
                          (backX, backY),                 # upper left corner
                          (backX+backWidth,backY+backHeight),        # lower right corner
                          (255, 0, 0),                  # blue
                          3)
